...
<head>
    ...
    <style>
        ...
        .section-spacing {
            padding: 0; /* Rimosso margine tra le sezioni */
        }
...
<body>
    <!-- Navbar Section -->
    <nav class="navbar scroll-transition" style="transform: translateY(-20px);">
        <div class="navbar__container">
            <a href="/" id="navbar__logo" style="display: flex; align-items: center;">
                <img src="images/logo.jpg" alt="TNI Logo" class="hover-scale" style="height: 50px; margin-right: 10px; transition: transform 0.3s ease;">
            </a>
